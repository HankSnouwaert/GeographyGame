...
namespace WPM {
    public partial class WorldMapGlobe : MonoBehaviour {
        ...
        void SetCountryGeoData(string s) {
			...
			char[] separatorCountries = { '$' };
			char[] separatorRegion =  { '*' };
			char[] separatorCoordinates = { ';' };
		...
		void DrawMapLabels () { 
			...
			for (int countryIndex = 0; countryIndex < countries.Length; countryIndex++) {
				...
				if (_labelsRenderMethod == LABELS_RENDER_METHOD.Blended && country.regionsRect2D.yMax > 180) {
