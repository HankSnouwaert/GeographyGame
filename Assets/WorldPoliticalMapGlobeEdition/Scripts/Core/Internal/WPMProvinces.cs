...
namespace WPM {
    ...
    public partial class WorldMapGlobe : MonoBehaviour {
        ...
        void SetProvincesGeoData(string s) {
            ...
            char[] provSep = { '$' };
            string[] provincesData = s.Split(new char[] { '|' }, StringSplitOptions.RemoveEmptyEntries);
            ...
            for (int k = 0; k < provinceCount; k++) {
                string[] provinceInfo = provincesData[k].Split(provSep, StringSplitOptions.RemoveEmptyEntries);
        ...
        public void ReadProvincePackedString(Province province) {
            ...
            province.packedRegions = null; // data no longer needed
