    ...
    public partial class WorldMapGlobe : MonoBehaviour {
            ...
            set {
                if (_cursorLocation != value) {
                    ...
                    if (_cursorFollowMouse && cursorLayer != null) {
                        cursorLayer.transform.forward = transform.TransformPoint(cursorLocation) - transform.position;
                    }
                }
            }
        }
        ...
        public GameObject AddPolygon3D(Vector2[] latlon, Color borderColor, Color fillColor = default(Color)) {
            ...
            if (borderColor.a > 0) {
                ...
                mf.mesh = mesh;
                Material mat = Instantiate<Material>(borderColor.a < 1f ? frontiersMatThinAlpha : frontiersMatThinOpaque);
