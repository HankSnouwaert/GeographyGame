    ...
    public class WorldMapGlobeInspector : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            if (expandEarthSection) {
                ...
                if (_map.showEarth) {
                    ...
                    if (_map.earthStyle == EARTH_STYLE.SolidColor) {
                        _map.earthColor = EditorGUILayout.ColorField("Color", _map.earthColor);
                    }
                    ...
                    if (_map.earthStyle.isScenic()) {
                        ...
                        EditorGUI.indentLevel++;
                        _map.atmosphereColor = EditorGUILayout.ColorField("Tint Color", _map.atmosphereColor);
                ...
                if (!_map.earthGlowScatter) {
                    _map.earthScenicGlowColor = EditorGUILayout.ColorField("Color", _map.earthScenicGlowColor);
            ...
            if (expandGridSection) {
                ...
                _map.gridLinesColor = EditorGUILayout.ColorField("Lines Color", _map.gridLinesColor);
                ...
                if (_map.showHexagonalGrid) {
                    ...
                    _map.hexaGridColor = EditorGUILayout.ColorField("Color", _map.hexaGridColor);
                    ...
                    _map.hexaGridHighlightColor = EditorGUILayout.ColorField("Highlight Color", _map.hexaGridHighlightColor);
            ...
            if (expandTilesSection) {
                ...
                if (_map.showTiles) {
                    ...
                    if (_map.tileServer == TILE_SERVER.Custom) {
                        ...
                        if (Application.isPlaying) {
                            EditorGUILayout.LabelField(new GUIContent("Client Id", "The client id of your Aeris Weather account."), "**************");
                        } else {
                        ...
                        if (Application.isPlaying) {
                            EditorGUILayout.LabelField(new GUIContent("Secret Key", "Secret key linked to your Aeris Weather account."), "**************");
                        } else {
            ...
            if (expandCountriesSection) {
                ...
                if (_map.showInlandFrontiers) {
                    EditorGUI.indentLevel++;
                    _map.inlandFrontiersColor = EditorGUILayout.ColorField("Color", _map.inlandFrontiersColor);
                    EditorGUI.indentLevel--;
                }
                ...
                if (_map.showCountryNames) {
                    ...
                    _map.countryLabelsSize = EditorGUILayout.Slider("Relative Size", _map.countryLabelsSize, 0.1f, 0.9f);
                    _map.countryLabelsAbsoluteMinimumSize = EditorGUILayout.Slider("Minimum Size", _map.countryLabelsAbsoluteMinimumSize, 0.29f, 2.5f);
            ...
            if (expandProvincesSection) {
                ...
                if (_map.showProvinces) {
                    ...
                    _map.provincesColor = EditorGUILayout.ColorField("Provinces Color", _map.provincesColor);
                    ...
                    if (_map.enableProvinceHighlight) {
                        EditorGUI.indentLevel++;
                        _map.provincesFillColor = EditorGUILayout.ColorField("Color", _map.provincesFillColor);
            ...
            if (expandCitiesSection) {
                ...
                if (_map.showCities && _map.cities != null) {
                    ...
                    _map.citiesRegionCapitalColor = EditorGUILayout.ColorField("Region Cap. Color", _map.citiesRegionCapitalColor);
                    _map.citiesCountryCapitalColor = EditorGUILayout.ColorField("Capital Color", _map.citiesCountryCapitalColor);
            ...
            if (expandFoWSection) {
                ...
                if (_map.showFogOfWar) {
                    ...
                    _map.fogOfWarColor1 = EditorGUILayout.ColorField("Color 1", _map.fogOfWarColor1);
                    _map.fogOfWarColor2 = EditorGUILayout.ColorField("Color 2", _map.fogOfWarColor2);
            ...
            if (expandInteractionSection) {
                ...
                if (_map.allowUserRotation) {
                    ...
                    EditorGUI.indentLevel++;
                    switch (_map.rightButtonDragBehaviour) {
                        case DRAG_BEHAVIOUR.Rotate:
            ...
            if (expandCameraControlSection) {
                ...
                if (_map.syncTimeOfDay)
                    GUI.enabled = false;
                _map.autoRotationSpeed = EditorGUILayout.Slider("AutoRotation Speed", _map.autoRotationSpeed, -2f, 2f);
